...
public class PostService {
    ...
    /**
     * Метод получения списка всех моделей {@link Post}.
    ...
    /**
     * Метод получения модели поста по идентификатору.
    ...
    /**
     * Метод добавления поста в репозиторий.
    ...
    /**
     * Метод удаления поста из репозитория.
     * @param id идентификатор поста.
